...
export default function Offers() {
  return (
    <div className="max-w-[1280px] mx-auto my-14">
      <h1 className="text-2xl font-bold">Offers</h1>
      <h2 className="text-deem my-2">
        Promotions, deals and special offers for you
      </h2>
      <div
        className="text-white bg-red-400 p-4 rounded-md bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      >
        <h1 className="text-xl font-bold">Seize the moment</h1>
        <h3 className="text-sm my-2">
          Save 15% or more when you book and stay before 1 October <br />
          2024
        </h3>
        <button className="bg-[#0057b8] px-4 py-2 text-sm rounded-md">
          Find Getaway Deals
        </button>
      </div>
    </div>
