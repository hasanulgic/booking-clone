...
export default function TravelInspiration() {
  return (
    <div className="container mb-8 sm:mb-20 px-2 sm:px-0">
      ...
      <div className="grid grid-rows-1 grid-cols-1 sm:grid-cols-4 w-full sm:gap-4">
        {/* <div className="slider-container"> */}
        {/* <Slider {...settings}> */}
        <div className="col-span-2 bg-gradient-to-br from-slate-600 to-slate-700 relative rounded-lg">
          <img
            className="object-cover h-full w-full sm:absolute mix-blend-overlay rounded-lg"
