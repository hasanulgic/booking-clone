export default function UniquePlace() {
  return (
    <div className="max-w-[1280px] mx-auto mb-10">
      <h1 className="text-2xl font-bold">Stay at our top unique properties</h1>
      ...
      <div className="grid grid-rows-1 grid-cols-4 w-full gap-6">
        <div className="shadow-2xl rounded-lg">
          ...
          <div className="px-3 pb-2">
            <h1 className="font-bold mt-2">Gyttja Västergårds</h1>
        ...
        <div className="shadow-2xl rounded-lg">
          ...
          />
          <div className="px-3 pb-2">
            <h1 className="font-bold mt-2">Harbor View</h1>
