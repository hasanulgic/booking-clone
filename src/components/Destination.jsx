...
export default function Destination() {
  return (
    <div className="max-w-[1280px] mx-auto my-6 px-2 sm:px-0">
      ...
      <div className="grid grid-rows-1 grid-cols-2 w-full gap-3 sm:gap-6">
        <div className="text-white rounded-md h-28 sm:h-60 w-full hover:border-2 border-[#ffb700] relative">
          <img
        ...
        <div
          className="text-white bg-red-400 p-4 rounded-md bg-cover bg-center h-28 sm:h-60 w-full hover:border-2 border-[#ffb700]"
          style={{
            backgroundImage:
      ...
      <div className="grid grid-rows-1 grid-cols-3 w-full gap-3 sm:gap-6 mt-5">
        <div
          className="text-white bg-red-400 p-4 rounded-md bg-cover bg-center h-28 sm:h-60 w-full hover:border-2 border-[#ffb700]"
          style={{
            backgroundImage:
