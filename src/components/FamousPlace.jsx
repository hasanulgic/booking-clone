  ...
  return (
    <div className="max-w-[1280px] mx-auto my-2">
      ...
      <div className="grid grid-rows-1 grid-cols-4 w-full gap-6">
        <div className="rounded-lg h-44 relative bg-gradient-to-b from-slate-400 to-slate-900">
          <img
          ...
          />
          <div className="p-4 text-white font-bold absolute bottom-1">
            <h1>Paris</h1>
            <p className="text-sm">2200+ attractions</p>
          </div>
        </div>

        <div className="rounded-lg h-44 relative bg-gradient-to-b from-slate-300 to-slate-700">
          <img
            className="h-full w-full object-fit mix-blend-overlay rounded-lg absolute"
        ...
        <div className="rounded-lg h-44 relative bg-gradient-to-b from-slate-300 to-slate-800">
          <img
            className="h-full w-full object-fit mix-blend-overlay rounded-lg absolute"
        ...
        <div className="rounded-lg h-44 relative bg-gradient-to-b from-slate-300 to-slate-900">
          <img
            className="h-full w-full object-fit mix-blend-overlay rounded-lg absolute"
