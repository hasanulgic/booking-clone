      ...
      <div className="grid grid-rows-1 grid-cols-6 w-full gap-2 sm:gap-5">
        ...
        <div>
          <img
            ...
            alt="room1"
          />
          <h2 className="text-xs sm:text-base font-bold mt-2 text-nowrap">Dhaka</h2>
          <h2 className="text-deem text-xs sm:text-sm text-nowrap">255 properties</h2>
        </div>
        <div>
          <img
            className="rounded-md"
            ...
            alt="room1"
          />
          <h2 className="text-xs sm:text-base font-bold mt-2 text-nowrap">Sylhet</h2>
          <h2 className="text-deem text-xs sm:text-sm text-nowrap">50 properties</h2>
        </div>
        <div>
          <img
            className="rounded-md"
            ...
            alt="room1"
          />
          <h2 className="text-xs sm:text-base font-bold mt-2 text-nowrap">Chittagong</h2>
          <h2 className="text-deem text-xs sm:text-sm text-nowrap">40 properties</h2>
        </div>
        <div>
          <img
            className="rounded-md"
            ...
            alt="room1"
          />
          <h2 className="text-xs sm:text-base font-bold mt-2 text-nowrap">Sreemangal</h2>
          <h2 className="text-deem text-xs sm:text-sm text-nowrap">27 properties</h2>
        </div>
        <div>
          <img
            className="rounded-md"
            ...
            alt="room1"
          />
          <h2 className="text-xs sm:text-base font-bold mt-2 text-nowrap">Kutakata</h2>
          <h2 className="text-deem text-xs sm:text-sm text-nowrap">10 properties</h2>
        </div>
      </div>
    </div>
  );
